...
export const Page = () => (
  <div>
    ...
    <p>
      ...
      cursus ut, gravida ut, lobortis eget, lacus. Sed diam. Praesent fermentum
    ...
    <SectionIndent>
      {{
        copy: (
          <p>
            Nunc eleifend leo vitae magna. Aliquam erat volutpat. Nunc eleifend
            leo vitae magna. In id erat non orci commodo lobortis. Proin neque
            ...
            dignissim bibendum. Vivamus id enim.
          </p>
        ),
      }}
    </SectionIndent>
    ...
    <h2 style={{ marginTop: '3rem' }}>Pages in Storybook</h2>
    <p>
