...
const schema = yup
  ...
  .shape({
    ...
    recherche_travail: yup.array().of(yup.string()),
    recherche_travail_secteur: yup.array().of(yup.string()),
    recherches_info: yup.array().of(yup.string()),
    recherches_info_texte: yup.array().of(yup.string()),
    satisfaction: yup.number(),
    taille_structure: yup.string(),
    travail_activite: yup.array().of(yup.string()),
